    ...
    <section class="sidebar">
        ...
        $menuItems = [
                ...
                ['label' => 'User Management','icon' => 'user','url' => '#','items' => [
                        ...
                        ['label' => 'User', 'icon' => 'dashboard', 'url' => ['/mimin/user'],],
                    ],
                ],
                ...
                ['label' => 'Kuisoner','icon' => 'graduation-cap','url' => '#','items' => [
                        ['label' => 'Kategori Kuisoner', 'icon' => 'list-ul', 'url' => ['/kuisoner-kategori/index'],'visible' => true,],
                        ['label' => 'List Kuisoner', 'icon' => 'list-ul', 'url' => ['/kuisoner/index'],'visible' => true,],
                        ['label' => 'Entry Kuisoner', 'icon' => 'file-code-o', 'url' => ['/kuisoner-user/index'],'visible' => true,],
                        ['label' => 'Input Kuisoner', 'icon' => 'edit', 'url' => ['/kuisoner-input/index'],'visible' => true,],
                        ['label' => 'Result', 'icon' => 'pie-chart', 'url' => ['/kuisoner-result/index'],'visible' => true,],
                    ],'visible' => true,
                ],
